        ...
        <div className="row mx-0 px-5 py-3">
          <div className="col-12 text-secondary py-5">
            ...
            {role === "ROLE_ADMIN" && (
                <>
                  <div
                      className="accordion-header mt-2 ms-2"
                      id="headingOne"
                  ...
                  >
                    <div className="d-flex">
                      <div className="nav-item my-2 me-4">
                        <button
                            className="btn nav-link text-truncate"
                            style={{
                        ...
                        >
                          <i className="fas fa-plus me-2"></i> {/* Plus icon with margin */}
                          Thêm mới
                        </button>
                      </div>
                      <div className="nav-item my-2">
                        ...
                        >
                          <i className="fas fa-list me-2"></i> {/* List icon with margin */}
                          Nhập số liệu
                        </button>
                      </div>
                    </div>
